...
// Cross-ref: design/04-npc-memory.md §Schema, §Decay, §Write path, §Read path
//            design/14-glossary.md §NPC Memory, §Salience, §Valence, §Disposition, §Pinned Memory
import { z } from 'zod';
import { NPCMemoryId, ActorId, WorldTime, Timestamp } from './common';

// ---------------------------------------------------------------------------
// Valence — emotional weight of an NPC memory entry (-3 to +3)
// Cross-ref: design/04-npc-memory.md §Schema; design/14-glossary.md §Valence
// ---------------------------------------------------------------------------
...
// Cross-ref: design/04-npc-memory.md §Schema; design/14-glossary.md §Salience
// ---------------------------------------------------------------------------
...
// Cross-ref: design/04-npc-memory.md §Schema (explicit TypeScript schema in design doc)
// ---------------------------------------------------------------------------
export const NPCMemorySchema = z.object({
  ...
  // Cross-ref: design/04-npc-memory.md §Decay
  ...
  // Cross-ref: design/04-npc-memory.md §Decay; design/14-glossary.md §Pinned Memory
  pinned: z.boolean(),
  ...
  // Cross-ref: design/13-risks-tripwires.md §1 (lock embedding model before first write)
...
// Cross-ref: design/04-npc-memory.md §Read path; design/14-glossary.md §Disposition
...
// Cross-ref: design/04-npc-memory.md §Write path (commit_npc_memory updates disposition)
// ---------------------------------------------------------------------------
